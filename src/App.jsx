...
import { BibliographyRu } from './data/Bibliography/BibliographyRu';
import { BibliographyGb } from './data/Bibliography/BibliographyGb'; 
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/bibliography/ru" element={<Bibliography bibliographyList={BibliographyRu} type='ru'/>} />
        <Route path="/bibliography/gb" element={<Bibliography bibliographyList={BibliographyGb}  type='gb'/>} />
