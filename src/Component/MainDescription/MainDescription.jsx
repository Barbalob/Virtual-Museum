...
import srcDecor from '../../assets/gold.svg'
...
const MainDescription = () => {
    ...
    return (
        <div className='main-description'>
            ...
            <img src={srcDecor} alt="" className="decor"/>
            <p className="main-description-text">Рубеж XVII–XVIII вв. как для Британии, так и для России стал периодом кризиса, переходом от «культуры духа» к «культуре разума». Уход от ренессансных моделей институционального развития, связанный с глубинной перестройкой механизмов осуществления власти, культуры и знания, ни мог не отразиться на бытовых практиках воспитания, обучения, формирования семьи, рождения ребенка и пр. Трансформация нравственных постулатов и ценностей в процессе преодоления системного кризиса переходной эпохи оказала существенное влияния на последующее развитие Британии и России.
            ...
            <img src="../../assets/gold.svg" alt="" className="decor"/>
